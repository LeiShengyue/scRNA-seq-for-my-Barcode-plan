...
# 读取数据文件
data1 <- readRDS("/Users/Desktop/がん研/experiment/scRNC-seq/summary/QCsample/CTRL.rds")
data2 <- readRDS("/Users/Desktop/がん研/experiment/scRNC-seq/summary/QCsample/MPS1ip1.rds")
data3 <- readRDS("/Users/Desktop/がん研/experiment/scRNC-seq/summary/QCsample/MPS1ip6.rds")
data4 <- readRDS("/Users/Desktop/がん研/experiment/scRNC-seq/summary/QCsample/MPS1ip12.rds")
data5 <- readRDS("/Users/Desktop/がん研/experiment/scRNC-seq/summary/QCsample/WGDp1.rds")
data6 <- readRDS("/Users/Desktop/がん研/experiment/scRNC-seq/summary/QCsample/WGDp7.rds")
...
# 加载注释文件并指定列名
annotations <- read.table("/Users/Desktop/がん研/experiment/scRNC-seq/summary/anno/mixanno.txt", header = FALSE, sep = "\t", col.names = c("Cell_Name", "Annotation"))
...
# 将过滤后的注释文件保存为临时文件
write.table(annotations_filtered, file = "/Users/Desktop/がん研/experiment/scRNC-seq/summary/anno/filteredmixanno.txt", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
infercnv_obj = infercnv::run(infercnv_obj, 
                             ...
                             out_dir="/Users/Desktop/がん研/experiment/scRNC-seq/summary/mix-output",  # dir is auto-created for storing outputs
...
infercnv::plot_cnv(infercnv_obj_medianfiltered,
                   out_dir="/Users/Desktop/がん研/experiment/scRNC-seq/summary/mix-output",
                   output_format="pdf",
